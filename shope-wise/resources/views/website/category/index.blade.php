                                    ...
                                    <div class="product_box text-center">
                                        <div class="product_img">
                                            <a href="shop-product-detail.html">
                                                <img src="{{asset($product->image)}}" width="200" height="245" alt="furniture_img1">
                                            </a>
                        ...
                        <div class="sidebar">
                            <div class="widget">
                                ...
                                <ul class="widget_categories">
                                    ...
                                    <li><a href="{{route('category', ['id' => $category->id])}}"><span class="categories_name">{{$category->name}}</span><span class="categories_num">({{$category->id}})</span></a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="widget">
