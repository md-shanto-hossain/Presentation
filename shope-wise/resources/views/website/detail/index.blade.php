                    ...
                    <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                        <div class="product-image">
                            <div class="product_img_box">
                                <img id="image" src="{{asset($product->image)}}" width="540" height="600" data-zoom-image="{{asset($product->image)}}" alt="Product main image" />
                                <a href="image" class="product_img_zoom" title="Zoom">
                            ...
                            <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                                ...
                                <div class="item">
                                    <a href="#" class="product_gallery_item active"  data-zoom-image="{{asset($otherImage->other_image)}}">
                                        <img src="{{asset($otherImage->other_image)}}" height="145" width="115" alt="Product Other Images" />
                                    </a>
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="pr_detail">
                            <div class="product_description">
                                <h4 class="product_title"><a href="{{route('detail', ['id' => $product->id])}}">{{$product->name}}</a></h4>
                            ...
                            <ul class="product-meta">
                                <li>Code: <a href="#">{{$product->code}}</a></li>
                                <li>Category: <a href="#">{{$product->category->name}}</a></li>
                                <li>Brand: <a href="#" rel="tag"></a> <a href="#" rel="tag">{{$product->brand->name}}</a> </li>
                            </ul>
